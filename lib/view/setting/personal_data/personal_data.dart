                                                            ...
                                                            Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(children: [
                                                                  ...
                                                                  if(InitSharedPreferences.getNameUser()!=null&&InitSharedPreferences.getNameUser()!.isNotEmpty)
                                                                    Text(
                                                                      InitSharedPreferences.getNameUser()!, style: const TextStyle(fontSize: 13,color: kblack38),
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(children: [
                                                                  ...
                                                                  if(InitSharedPreferences.getPhoneUser()!=null&&InitSharedPreferences.getPhoneUser()!.isNotEmpty)
                                                                    Text(InitSharedPreferences.getPhoneUser().toString(), style: const TextStyle(fontSize: 13,color: kblack38),)
                                                                ],),
                                                              ],
                                                            ),
                                                            const SizedBox(height: 7,),
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(children: [
                                                                  ...
                                                                  if(InitSharedPreferences.getEmailUser()!=null&&InitSharedPreferences.getEmailUser()!.isNotEmpty)
                                                                    Text(InitSharedPreferences.getEmailUser()!, style: const TextStyle(fontSize: 13,color: kblack38),)
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(children: [
                                                                  ...
                                                                  if(InitSharedPreferences.getAddressUser()!=null&&InitSharedPreferences.getAddressUser()!.isNotEmpty)
                                                                    Text(InitSharedPreferences.getAddressUser()!, style: const TextStyle(fontSize: 13,color: kblack38))
